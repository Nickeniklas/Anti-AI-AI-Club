...
### 8. The Form (MAIN CONVERSION BLOCK — give it room)
- **Heading:** What should we cover?
- **Subtext:** Pick what you actually care about. That's the whole ask — takes about 10 seconds.
- **Field 1 — "Pick what you care about"** (checkboxes; REQUIRED — at least one must be ticked, this is the only required input):
...
- BUILD NOTES:
  ...
  - Email is deliberately the bottom-most field so the email ask never scares off someone who doesn't know the club yet.
...
### Stat-handling rules (these travel with the numbers above)
...
- If a figure can't be sourced, it doesn't go on the site.
