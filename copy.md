...
### 1. Hero
- **Headline:** AI is here to stay. The hype around it is blinding everyone to the actual numbers.
...
### 3. The Form (MAIN CONVERSION BLOCK)
- **Heading:** What should we cover?
- **Subtext:** Pick what you actually care about. That's the whole ask — takes about 10 seconds.
- **Field 1 — "Pick what you care about"** (checkboxes; REQUIRED — at least one must be ticked):
...
- **Field 2 — "What worries you most about AI?"** (OPTIONAL free text). Placeholder: `Optional — one line is fine. Helps us write for you.`
- **Field 3 — Email** (OPTIONAL, last). Label: **"Want to hear from us? Drop an email. Totally optional ✳"** Placeholder: `you@email.com — only if you want to`
  - Helper line: `✳ Completely optional. We'll only ever email you when we've got something genuinely worth showing — and never anything else.`
- **Submit button:** Send it in
- **Confirmation:** Got it — thanks for telling us what matters to you. If you left an email, you'll only hear from us when there's something real worth sharing. Want to help shape it more? Send us an article worth reading: antibsai@gmail.com.
...
- Links: Home · About · Submit an article · Contact
- Legal: Privacy · Terms · © 2026 Anti-AI, AI Club
- Microcopy: If you left an email, we use it only to reach you about the club. Unsubscribe anytime.
